            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="header-action">
                    ...
                    <ol class="breadcrumb page-breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Inspection Category</li>
                    </ol>
                </div>
                <ul class="nav nav-tabs page-header-tab">
                    {{-- <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Student-all" id="list-tab">List</a></li> --}}
                    @can('Inspection Category Create')
                    <li class="nav-item"><a class="btn btn-info" href="{{ route('checklist-categorie.create') }}"><i class="fa fa-plus"></i>Add New</a></li>
                    @endcan
                </ul>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('checklist-categorie.edit',$item->id) }}" class="btn btn-icon btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                                @endcan
                                                @can('Inspection Category Delete')
                                                <form action="{{ route('checklist-categorie.destroy',$item->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
