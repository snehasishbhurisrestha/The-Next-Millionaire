@extends('layouts.app')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="header-action">
                    ...
                    <ol class="breadcrumb page-breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Inspection Category</li>
                    </ol>
                </div>
    ...
    <form action="{{ route('checklist-categorie.store') }}" method="post" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control" placeholder="Enter Max Score" name="max_score" value="{{ old('max_score') }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
