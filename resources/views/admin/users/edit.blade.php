                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Enter Business Name" name="business_name" value="{{ $user->business->business_name }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Business Category <span class="text-danger">*</span></label>
                                <div class="col-md-9">
                                    <select class="form-control input-height" name="business_category" required>
                                        <option value selected disabled>Select...</option>
                                        @foreach($business_categorys as $business_category)
                                        <option value="{{ $business_category->id }}" @if($user->business->business_category_id == $business_category->id) selected @endif>{{ $business_category->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="business_address" value="{{ $user->business->business_address }}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Trade License Number <span class="text-danger"></span></label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="trade_license_number" value="{{ $user->business->trade_license_number }}" placeholder="Trade License Number">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Trade License Image</label>
                                <div class="col-md-9">
                                    <input type="file" class="dropify" name="trade_license_image">
                                </div>
                            </div>
                        </div>
                    </div>
