            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="header-action">
                    ...
                    <ol class="breadcrumb page-breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('certification-type.index') }}">Certification Type</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Certification Type</li>
                    </ol>
                </div>
                <ul class="nav nav-tabs page-header-tab">
                    {{-- <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Student-all" id="list-tab">List</a></li> --}}

                    <li class="nav-item"><a class="btn btn-info" href="{{ route('certification-type.index') }}"><i class="fa fa-arrow-left me-2"></i>Back</a></li>
                </ul>
            </div>
        </div>
    </div>

    <form action="{{ route('certification-type.update',$item->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Certificate Image</h3>
                            <div class="card-options ">
                                {{-- <a href="#" class="card-options-collapse" data-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a>
                                <a href="#" class="card-options-remove" data-toggle="card-remove"><i class="fe fe-x"></i></a> --}}
                            </div>
