@extends('layouts.app')
    ...
    <form action="{{ route('certification-type.store') }}" method="post" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea rows="4" class="form-control no-resize" placeholder="Enter Description" name="description">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
