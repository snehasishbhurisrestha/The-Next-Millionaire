                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Enter name" name="name" value="{{ $item->title }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control input-height" name="blog_category" required>
                                        ...
                                        <option value="{{ $blog_caregorie->id }}" @if($item->blog_category_id == $blog_caregorie->id) selected @endif>{{ $blog_caregorie->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea rows="4" class="form-control no-resize summernote" placeholder="Enter Sort Description" name="sort_description">{{ $item->sort_description }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Long Description</label>
                                <div class="col-md-9">
                                    <textarea rows="4" class="form-control no-resize summernote" placeholder="Enter Description" name="description">{{ $item->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
