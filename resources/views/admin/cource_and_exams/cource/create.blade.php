                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row" id="cource-price">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control" placeholder="Enter Offer price" name="offer_price" id="priceField" value="{{ old('offer_price') }}" step="0.01">
                                </div>
                            </div>
                        </div>
                    </div>
