@extends('layouts.app')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="header-action">
                    ...
                    <ol class="breadcrumb page-breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('exam-questions.index',request()->segment(2)) }}">Exam Questions</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Exam Questions</li>
                    </ol>
                </div>
    ...
    <form action="{{ route('exam-questions.update',$item->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea rows="4" class="form-control" placeholder="Enter question" name="question" required>{{ old('question',$item->question) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="option_a" placeholder="Enter Option A" value="{{ old('option_a',$item->option_a) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="option_b" placeholder="Enter Option B" value="{{ old('option_b',$item->option_b) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="option_c" placeholder="Enter Option C" value="{{ old('option_c',$item->option_c) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="option_d" placeholder="Enter Option D" value="{{ old('option_d',$item->option_d) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="correct_answer" required>
                                        <option @if($item->correct_answer == '') selected @endif value="">Select Correct Answer</option>
                                        <option @if($item->correct_answer == 'a') selected @endif value="a">Option A</option>
                                        <option @if($item->correct_answer == 'b') selected @endif value="b">Option B</option>
                                        <option @if($item->correct_answer == 'c') selected @endif value="c">Option C</option>
                                        <option @if($item->correct_answer == 'd') selected @endif value="d">Option D</option>
                                    </select>
                                </div>
                            </div>
                        </div>
