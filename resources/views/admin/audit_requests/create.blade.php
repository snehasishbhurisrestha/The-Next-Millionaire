            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="header-action">
                    ...
                    <ol class="breadcrumb page-breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Audit Enquiry</li>
                    </ol>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control input-height" name="certification" required>
                                        ...
                                        <option value="{{ $certification_type->id }}">{{ $certification_type->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input data-provide="datepicker" data-date-autoclose="true" class="form-control" name="audit_date" value="{{ old('audit_date') }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
