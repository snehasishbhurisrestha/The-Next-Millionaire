...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <h6 class="h6 mb-0 text-light-800" style="color: white;">
            ...
            <!-- AddToAny BEGIN -->
            <div class="a2a_kit a2a_kit_size_32 a2a_default_style" data-a2a-url="{{ $shareUrl }}" data-a2a-title="💡 The Next Millionaire is a digital learning platform that teaches you how to build online income without investment and scale your social media growth step by step 📈" style="line-height: 32px;">
                <a class="a2a_dd" href="https://www.addtoany.com/share'#url={{ $shareUrl }}&amp;title={{ urlencode('💡 The Next Millionaire is a digital learning platform that teaches you how to build online income without investment and scale your social media growth step by step 📈') }}"><span class="a2a_svg a2a_s__default a2a_s_a2a" style="background-color: rgb(1, 102, 255);"><svg focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><g fill="#FFF"><path d="M14 7h4v18h-4z"></path><path d="M7 14h18v4H7z"></path></g></svg></span><span class="a2a_label a2a_localize" data-a2a-localize="inner,Share">Share</span></a>
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Referral Clicks</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ auth()->user()->refer_link_click ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
